<<<<<<< HEAD:application/controllers/c_authorization.php
<?php
/*helps authenticate a user*/
class C_authorization extends MY_Controller {
...
class Auth extends MY_Controller {
	...
	public function login() {
		...
		//Working with an object of the entity
		$user = $this -> em -> getRepository('models\SystemUser') -> findOneBy(array('userName' => $this -> input -> post('username'), 'userPassword' => $this -> input -> post('secret')));
...
?>
>>>>>>> a941ac898035a5eaf864579e3039abf840568c60:application/controllers/auth.php
